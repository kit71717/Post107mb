...
# get active source.
file_3 = [k for (k, v) in GetSources().items()][0][0]
file_4 = [k for (k, v) in GetSources().items()][1][0]
...
# User Input
cross_num = float(raw_input("How many cross section?"))
...
for x in range(cross_num):
    ...
    # User Input
    g = float(raw_input("What is the input?"))
